...
import {defaultTextRangeValus, defaultTextColor} from '../consts';
...
class Text extends Submenu {
    constructor(subMenuElement, {locale, iconStyle, menuBarPosition}) {
        ...
        this._els = {
            ...
            textColorpicker: new Colorpicker(this.selector('#tie-text-color'), defaultTextColor, this.toggleDirection),
